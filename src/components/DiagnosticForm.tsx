...
export default function DiagnosticForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      {results.length > 0 && (
        <div className="space-y-4">
          <h3 className="text-xl font-semibold">Possíveis Problemas Identificados:</h3>
            ...
            <Card key={index}>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold mb-2">Peças Afetadas:</h4>
                  ...
                  <div>
                    ...
                    <p><strong>Custo Estimado:</strong> €{result.cost}</p>
                    <p><strong>Urgência:</strong> {result.urgency}</p>
                  </div>
                </div>
                <div className="mt-4">
                  <h4 className="font-semibold mb-2">Ações Imediatas Recomendadas:</h4>
                  <ul className="list-disc list-inside space-y-1">
